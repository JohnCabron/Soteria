...
namespace Soteria.Server.Services
{
    public class TokenAuthenticationService : IAuthenticateService
    {
        ...
        private readonly TokenConfiguration _tokenManagement;

        public TokenAuthenticationService(IUserManagementService service, IOptions<TokenConfiguration> tokenManagement)
        {
